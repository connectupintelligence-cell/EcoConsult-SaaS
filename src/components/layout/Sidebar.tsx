...
import { 
  LayoutDashboard, FileText, FolderKanban, Award, Files, DollarSign, Users, ShieldCheck, Leaf 
} from 'lucide-react';

export type TabType = 'dashboard' | 'crm' | 'projects' | 'licensing' | 'documents' | 'financial' | 'team' | 'audit';
